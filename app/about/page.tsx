        ...
        <main className="container mb-16">
          <section className="flex flex-col gap-10 w-xl p-6">
            <p className="leading-7">
              ...
              tristique gravida. In euismod nibh eu neque dignissim, vitae
              finibus velit dictum. Suspendisse ac faucibus lacus. Praesent quam
              ante, ornare ac sapien commodo, elementum tempus neque.{" "}
            </p>
            <p className="leading-7">
              ...
              Fusce mollis varius justo, non congue dui accumsan ut. Nam sit
              amet ante massa. Etiam in justo nisl. Fusce eget tincidunt enim.
              Aliquam vel interdum ligula. Suspendisse potenti. Donec suscipit
              leo in justo vestibulum cursus.
            </p>
            <p className="leading-7">
